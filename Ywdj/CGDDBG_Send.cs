...
{
    [Description("采购订单变更单审核--推送MES")]
    public class CGDDBG_Send : AbstractOperationServicePlugIn
    {
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            foreach (DynamicObject entity in e.DataEntitys)
            {
                ...
                if (entity != null)
                {
                    ...
                    string sql = string.Format(@"/*dialect*/ exec yzx_cgddbgd '{0}'", FID);
                    DynamicObjectCollection data = DBUtils.ExecuteDynamicObject(this.Context, sql);
                    
                    string sqlzx = string.Format(@"/*dialect*/ exec yzx_cgddbgdEntry '{0}'", FID);
                    ...
                    Dbhple.Log.writestr("采购订单变更单：" + data[0]["purOrderCode"].ToString(), body.ToString(), responseMsg.ToString(), "_采购订单变更单");
